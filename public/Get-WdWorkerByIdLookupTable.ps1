function Get-WdWorkerByIdLookupTable {
    <#
    .SYNOPSIS
    ...
    Get-WdWorker -IncludeInactive:$IncludeInactive -Human_ResourcesUri $Human_ResourcesUri -Username:$Username -Password:$Password | ForEach-Object {
