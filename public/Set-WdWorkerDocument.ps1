...
.PARAMETER StaffingUri
    ...
    stored with Set-WdEndpoint -Endpoint Staffing is used.
...
Set-WdWorkerDocument -WorkerId 123 -Path Document.pdf
...
'@
	...
	Invoke-WdRequest -Request $request -Uri $StaffingUri -Username:$Username -Password:$Password | Write-Output
