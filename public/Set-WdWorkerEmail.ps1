...
Set-WdWorkerEmail -WorkerId 123 -WorkEmail worker@example.com
...
<bsvc:Maintain_Contact_Information_for_Person_Event_Request bsvc:version="v30.0" bsvc:Add_Only="false" xmlns:bsvc="urn:com.workday/bsvc">
	<bsvc:Business_Process_Parameters>
		...
		<bsvc:Comment_Data>
			<bsvc:Comment>Email set by Set-WdWorkerEmail</bsvc:Comment>
		</bsvc:Comment_Data>
	</bsvc:Business_Process_Parameters>
...
'@
	...
	Invoke-WdRequest -Request $request -Uri $Human_ResourcesUri -Username:$Username -Password:$Password | Write-Output
