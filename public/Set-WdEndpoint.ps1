...
.DESCRIPTION
    ...
    can be saved to a user's profile using Save-WdConfiguration.
...
Set-WdEndpoint -Endpoint Staffing -Uri 'https://SERVICE.workday.com/ccx/service/TENANT/Staffing/v26.0'
