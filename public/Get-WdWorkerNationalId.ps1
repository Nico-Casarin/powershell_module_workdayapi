function Get-WdWorkerNationalId {
<#
.SYNOPSIS
...
Get-WdWorkerNationalId -WorkerId 123
...
#>
    ...
    if ($PsCmdlet.ParameterSetName -eq 'Search') {
        $response = Get-WdWorker -WorkerId $WorkerId -WorkerType $WorkerType -IncludePersonal -Human_ResourcesUri $Human_ResourcesUri -Username:$Username -Password:$Password -IncludeInactive:$IncludeInactive -ErrorAction Stop
