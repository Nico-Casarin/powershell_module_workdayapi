...
$response = Invoke-WdRequest -Request '<bsvc:Server_Timestamp_Get xmlns:bsvc="urn:com.workday/bsvc" />' -Uri https://SERVICE.workday.com/ccx/service/TENANT/Human_Resources/v25.1
...
At C:\Program Files\WindowsPowerShell\Modules\WorkdayApi\scripts\Invoke-WdRequest.ps1:104 char:3
